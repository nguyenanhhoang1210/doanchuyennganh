	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 push-sm-2">
				<form action="themnhom/insertData_controller" method="POST" enctype="multidata/form=data">
							<div class="card">
							<div class="card-block">
								<fieldset class="form-group">
									<label for="formGroupExampleInput">Họ Tên SV1: </label>
									<input type="text" name="hoten1" class="form-control" id="formGroupExampleInput" placeholder="Nguyễn Văn A" required>
								</fieldset>
								<fieldset class="form-group">
									<label for="formGroupExampleInput2">MSSV</label>
									<input type="text" name="mssv1" class="form-control" id="formGroupExampleInput2" placeholder="DH123456789" required>
								</fieldset>
								<fieldset class="form-group">
								...
								<fieldset class="form-group">
									...
									<input type="text" name="lop" class="form-control" id="formGroupExampleInput2" placeholder="Nhập lớp" required>
								</fieldset>
								<fieldset class="form-group">
									<label for="formGroupExampleInput2">Ngành</label>
									<input type="text" name="nganh" class="form-control" id="formGroupExampleInput2" placeholder="Nhập ngành" required>
								</fieldset>
								<fieldset class="form-group">
