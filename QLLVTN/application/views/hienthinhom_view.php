			...
			<?php foreach ($dulieutucontroller as $key => $value): ?>
				<div class="col-sm-4">
					<div class="card card-block">
						...
						<p class="card-text">Mã GV hướng dẫn : <?= $value['magv']?></p>
						<p class="card-text">Tên GV hướng dẫn : <?= $value['tengv']?></p>
						<a href="hienthinhom/deleteThongTinNhom/<?= $value['manhom'] ?>" class="btn btn-danger xoa"><i class="fa fa-times"></i></a>
					</div>
				</div>
			<?php endforeach ?>
		</div>
